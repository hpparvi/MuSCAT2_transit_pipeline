...
setup(name='MuSCAT2TA',
      ...
      scripts=['bin/m2organize', 'bin/lcoorganize', 'bin/m2photometry', 'bin/lcophotometry', 'bin/m2dfphotometry', 'bin/m2astrometry', 'bin/m3astrometry',
               'bin/m2nbtemplate', 'bin/m2init', 'bin/m2update', 'bin/m2mkref', 'bin/lcomkref', 'bin/m2findtarget'],
      license='GPLv2',
      classifiers=[
